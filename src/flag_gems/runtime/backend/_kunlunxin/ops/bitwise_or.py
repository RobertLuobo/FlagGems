...
def bitwise_or_tensor(A, B):
    ...
    # ~17us -> ~5.2us, single-variable A/B, harness/solution/
    # bitwise_tensor_family/README_out0.md).  The (4096,4096) cases are device
    # bound and are unaffected.  This also covers the `__or__.Tensor` entry
    # (dunder_or_tensor), which routes to this function.
    #
